...
insert into data_bank.regions (region_id, region_name)
values 
('1', 'Australia'),
  ('2', 'America'),
  ('3', 'Africa'),
...
insert into data_bank.customer_nodes (customer_id, region_id, node_id,start_date, end_date)
values 
...
insert into data_bank.customer_transactions (customer_id, txn_date, txn_type,txn_amount)
  values 
